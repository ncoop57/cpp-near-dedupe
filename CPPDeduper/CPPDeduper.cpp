...
const int expectedDocs = 60000000; //TODO: make this a parameter
...
public:
        ...
        double matchThresh, int numHasherThreads, int maxRecordsLoaded, int hashSize)
    {
        ...
        ComparerThread<HASH_TYPE, NUM_HASHES, HASH_BLOCK_SIZE>* comparerThread =
            new ComparerThread<HASH_TYPE, NUM_HASHES, HASH_BLOCK_SIZE>(true, &threadPool, expectedDocs, std::max(1U, numThreads - baseThreads));
